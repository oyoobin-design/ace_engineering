...
// Canadian Solar은 외국사모(FPI) → 8-K 대신 6-K 사용
const SUBMISSIONS_URL = "https://data.sec.gov/submissions/CIK0001375877.json";
const CIK = "1375877";
const EDGAR_HEADERS = { "User-Agent": "ace-biz-dashboard oyoobin@gmail.com" };
const ENTITY = "Canadian Solar Inc. (CSIQ)";
...
아래 ${filings.length}개 ${ENTITY} 공시에 대해 ACE 사업 관점에서 요약과 태그를 JSON으로만 반환해줘.
