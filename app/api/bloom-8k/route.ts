...
const SUBMISSIONS_URL = "https://data.sec.gov/submissions/CIK0001664703.json";
const CIK = "1664703";
const EDGAR_HEADERS = { "User-Agent": "ace-biz-dashboard oyoobin@gmail.com" };
const ENTITY = "Bloom Energy Corporation (BE)";
...
async function generateSummaryAndTag(filings: Filing8K[], docTexts: string[], candidates: EmbeddingCandidate[]): Promise<{ summaries: string[]; tags: TagType[] }> {
